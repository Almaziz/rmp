...
nuts = ImageIO.read(Game.class.getResourceAsStream("sneg3.png"));
end = ImageIO.read(Game.class.getResourceAsStream("ded.png"));
game_game = new Game();
...
float drop_right = drop_left + nuts.getWidth(null); float drop_bottom = drop_top + nuts.getHeight(null);
